 ...
 */
public class TambahMisi extends javax.swing.JDialog {
    private static TambahMisi tambahMisi;
     ...
     */
    public TambahMisi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        TambahMisi.parent = parent;
        TambahMisi.modal = modal;
        initComponents();
    }
    
    public static TambahMisi getInstance(java.awt.Frame parent, boolean modal) {
        if ((tambahMisi == null) || (TambahMisi.parent != parent) || (TambahMisi.modal != modal)) {
            tambahMisi = new TambahMisi(parent, modal);
        }
        return tambahMisi;
    }
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        String sql = "INSERT INTO misi (no_kandidat, teks_misi) VALUES (?, ?)";
        if (this.textAreaMisi.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(this, "Misi tidak boleh kosong.", "Kesalahan", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahMisi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahMisi dialog = new TambahMisi(new javax.swing.JFrame(), true);
